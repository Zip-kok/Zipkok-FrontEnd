    ...
    <div className={styles.root}>
      ...
      <div className={styles.body}>
        ...
        <button className={styles.profileEdit}>
          <img src={edit}/>프로필 수정하기
        </button>

        <div className={styles.bodyBtns}>
          <IconTextBtn image={heart} text="찜한 매물" onClick={handleKeepClick} />
          <IconTextBtn image={pen} text="리스트 항목 수정" onClick={handleListEditClick} />
          <IconTextBtn image={pin} text="나의 핀" onClick={handlePinClick} />
        </div>
        <div className={styles.btnList}>
        <IconTextBtn image={location_Pin} text="최근 본 매물" onClick={handleRecentClick} />
        <IconTextBtn image={notice} text="공지사항" onClick={handleNoticeClick} />
        <IconTextBtn image={inquiry} text="문의하기" onClick={handleInquiryClick} />
        <IconTextBtn image={logout} text="로그아웃" onClick={handleLogoutClick} />
