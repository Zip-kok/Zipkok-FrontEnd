...
import oneroomIcon from "../../../assets/oneroom.svg";
import tworoomIcon from "../../../assets/tworoom.svg";
import officetelIcon from "../../../assets/officetel.svg";
    ...
    return (
        <div className={styles.root}>
            ...
            <div className={styles.typeBtnContainer}>
                <button
                    className={`${styles.typeBtn} ${houseType === "아파트" ? styles.selected : ""}`}
                ...
                <button
                    className={`${styles.typeBtn} ${houseType === "원룸" ? styles.selected : ""}`}
                ...
                <button
                    className={`${styles.typeBtn} ${houseType === "빌라/투룸" ? styles.selected : ""}`}
                ...
                <button
                    className={`${styles.typeBtn} ${houseType === "오피스텔" ? styles.selected : ""}`}
